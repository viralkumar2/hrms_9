                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box">
                                ...
                                {{ Form::text('start_month', isset($_GET['start_month']) ? $_GET['start_month'] : '', ['class' => 'month-btn form-control d_filter current_date', 'autocomplete' => 'off' ,'placeholder'=>'Select start month']) }}
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box">
                                ...
                                {{ Form::text('end_month', isset($_GET['end_month']) ? $_GET['end_month'] : '', ['class' => 'month-btn form-control d_filter current_date', 'autocomplete' => 'off' ,'placeholder'=>'Select end month']) }}

                        ...
                        <tbody>
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Employee')): ?>
                                            <?php if($employee->login_sts['login_status'] == 0): ?>
                                                <div class="action-btn bg-danger ms-2">
                                                    <a href="<?php echo e(route('active_user',$employee->id)); ?>" class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                            ...
                                            <?php else: ?>
                                                <div class="action-btn bg-success ms-2">
                                                    <a href="<?php echo e(route('inactive_user',$employee->id)); ?>" class="mx-3 btn btn-sm  align-items-center bs-pass-para"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/employee/index.blade.php ENDPATH**/ ?>
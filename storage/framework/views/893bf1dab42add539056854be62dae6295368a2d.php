            ...
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <select name="status" id="status" class="form-control">
                        <option <?php if($department->status == 'Active'): ?> selected <?php else: ?> <?php endif; ?> value="Active">Active</option>
                        <option <?php if($department->status == 'In-Active'): ?> selected <?php else: ?> <?php endif; ?> value="In-Active">In-Active</option>
                    </select>
                </div>
            </div>
        </div>
...
<?php /**PATH E:\wamp64\www\hrms_9\resources\views/department/edit.blade.php ENDPATH**/ ?>
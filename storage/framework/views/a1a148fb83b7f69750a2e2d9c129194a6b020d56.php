                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($department->status == 'Active'): ?>
                                            <a href="<?php echo e(route('department_in_active',$department->id)); ?>" class="btn btn-success btn-sm"onclick="return confirm('Are you sure?')">Active</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('department_active',$department->id)); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">In-Active</a>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/department/index.blade.php ENDPATH**/ ?>
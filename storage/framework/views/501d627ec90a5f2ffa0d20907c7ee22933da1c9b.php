			...
			<div class="col-sm-12 col-md-6">
                    ...
                    <h5><?php echo e(__('Personal Detail')); ?></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong class="font-bold"><?php echo e(__('Marital')); ?> :</strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    ...
                                    <span><?php echo e($employee->employe_status); ?></span>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong class="font-bold"><?php echo e(__('Employee Types')); ?> :</strong>
                                    <span><?php echo e($employee->employe_types); ?></span>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong class="font-bold"><?php echo e(__('Experience')); ?> :</strong>
                                    <span><?php echo e($employee->employee_experience); ?></span>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong class="font-bold"><?php echo e(__('Date on Exit')); ?> :</strong>
                                    <span><?php echo e($employee->date_of_exit); ?></span>
                                </div>
                            </div>
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <h5><?php echo e(__('Work Experience-TABLE')); ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Previous Company')); ?> : </strong>
                                <span><?php echo e($employee->previous_company_name); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info text-sm font-style">
                                <strong class="font-bold"><?php echo e(__('Job Title')); ?> :</strong>
                                <span><?php echo e($employee->previous_job_title); ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('From Date')); ?> :</strong>
                                <span><?php echo e($employee->previous_from_date); ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('To Date')); ?> :</strong>
                                <span><?php echo e($employee->previous_to_date); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Designation')); ?> :</strong>
                                <span><?php echo e($employee->previous_company_designation_id); ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Experience Job Description')); ?> :</strong>
                                <span><?php echo e($employee->experiance_Job_description); ?></span>
                            </div>
                        </div>
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <h5><?php echo e(__('Education-TABLE')); ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Institute Name')); ?> : </strong>
                                <span><?php echo e($employee->institute_name); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info text-sm font-style">
                                <strong class="font-bold"><?php echo e(__('Education')); ?> :</strong>
                                <span><?php echo e($employee->education); ?></span>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Specialization')); ?> :</strong>
                        ...
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Date of completion')); ?> :</strong>
                                <span><?php echo e($employee->date_of_completion); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Notes')); ?> :</strong>
                                <span><?php echo e($employee->notes); ?></span>
                            </div>
                        </div>
                ...
                <h5><?php echo e(__('Dependent')); ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Name')); ?> : </strong>
                                <span><?php echo e($employee->dependent_name); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info text-sm font-style">
                                <strong class="font-bold"><?php echo e(__('Relation ')); ?> :</strong>
                                <span><?php echo e($employee->dependent_relation); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info text-sm">
                                <strong class="font-bold"><?php echo e(__('Date of completion')); ?> :</strong>
                                <span><?php echo e($employee->dependent_dob); ?></span>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/employee/show.blade.php ENDPATH**/ ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($role->activation_status == 1): ?>
                                            <div class="action-btn bg-success ms-2">
                                                <a href="<?php echo e(route('inactive_role',$role->id)); ?>" class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                        ...
                                        <?php else: ?>
                                            <div class="action-btn bg-danger ms-2">
                                                <a href="<?php echo e(route('active_role',$role->id)); ?>" class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                    data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"
                                                    aria-label="Delete"><i
                                                        class="ti ti-trash text-white text-white"></i>
                                                </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/role/index.blade.php ENDPATH**/ ?>
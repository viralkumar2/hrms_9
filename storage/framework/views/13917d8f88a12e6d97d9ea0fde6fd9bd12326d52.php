                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">
                                <div class="badge p-2 px-3 rounded bg-primary"><?php echo e(ucfirst($user->type)); ?></div>
                                    ...
                                    <div class="badge  rounded bg-danger"><a href="<?php echo e(route('active_user',$user->id)); ?>" class=" text-white text-white">In-Active</a> </div>
                                        
                                    <?php else: ?>
                                    <div class="badge rounded bg-success"> <a href="<?php echo e(route('inactive_user',$user->id)); ?>" class=" text-white text-white">Active</a> </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/user/index.blade.php ENDPATH**/ ?>
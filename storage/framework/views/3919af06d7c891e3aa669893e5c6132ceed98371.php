                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user">
                                            <select name="employe_status" id="employe_status" class="form-control select2">
                                                ...
                                                <option <?php if($employee->employe_status == "Active"): ?> selected <?php else: ?>  <?php endif; ?> value="Active">Active</option>
                                                <option <?php if($employee->employe_status == "Terminated"): ?> selected <?php else: ?>  <?php endif; ?> value="Terminated">Terminated</option>
                                                <option <?php if($employee->employe_status == "Deceased"): ?> selected <?php else: ?>  <?php endif; ?> value="Deceased">Deceased</option>
                                                <option <?php if($employee->employe_status == "Resigned"): ?> selected <?php else: ?>  <?php endif; ?> value="Resigned">Resigned</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user">
                                            <select name="employe_types" id="employe_types" class="form-control select2">
                                                <option <?php if($employee->employe_types == "Permanent"): ?> selected <?php else: ?>  <?php endif; ?> value="Permanent">Permanent</option>
                                                <option <?php if($employee->employe_types == "Temporary"): ?> selected <?php else: ?>  <?php endif; ?> value="Temporary">Temporary</option>
                                                <option <?php if($employee->employe_types == "On Contract"): ?> selected <?php else: ?> <?php endif; ?> value="On Contract">On Contract</option>
                                                <option <?php if($employee->employe_types == "Trainee"): ?> selected <?php else: ?> <?php endif; ?> value="Trainee">Trainee</option>
                            ...
                            <div class="card-body employee-detail-create-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo Form::text('previous_company_designation_id', $employee->previous_company_designation_id, [
                                            'class' => 'form-control',
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-icon-user">
                                            <select name="dependent_relation" id="dependent_relation" class="form-control select2">
                                                ...
                                                <option <?php if($employee->dependent_relation == "Permanent"): ?> selected <?php else: ?>  <?php endif; ?> value="Father">Father</option>
                                                <option <?php if($employee->dependent_relation == "Mother"): ?> selected <?php else: ?>  <?php endif; ?> value="Mother">Mother</option>
                                                <option <?php if($employee->dependent_relation == "Brother"): ?> selected <?php else: ?>  <?php endif; ?> value="Brother">Brother</option>
                                                <option <?php if($employee->dependent_relation == "Sister"): ?> selected <?php else: ?>  <?php endif; ?> value="Sister">Sister</option>
                                                <option <?php if($employee->dependent_relation == "Husband"): ?> selected <?php else: ?>  <?php endif; ?> value="Husband">Husband</option>
                                                <option <?php if($employee->dependent_relation == "Wife"): ?> selected <?php else: ?>  <?php endif; ?> value="Wife">Wife</option>
                                                <option <?php if($employee->dependent_relation == "Child"): ?> selected <?php else: ?>  <?php endif; ?> value="Child">Child</option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/employee/edit.blade.php ENDPATH**/ ?>
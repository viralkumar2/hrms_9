                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <h6 class="card-text small text-primary"><?php echo e($event->occasion); ?>

                                                </h6>
                                                <div class="card-text small text-dark">Start Date :
                                                    <?php echo e(date('d F Y', strtotime($event->start_date))); ?>

                                                </div>
                                                <div class="card-text small text-dark">End Date :
                                                    <?php echo e(date('d F Y', strtotime($event->end_date))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\hrms_9\resources\views/holiday/calender.blade.php ENDPATH**/ ?>